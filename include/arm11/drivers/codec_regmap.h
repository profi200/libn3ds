...
#define HEADSET_SEL_HP         BIT(HEADSET_SEL_HP_SHIFT)  // Force headphone output.
#define HEADSET_SEL_HP_EN      BIT(5)                     // Enable headphone override.
#define HEADSET_SEL_MIC_SHIFT  (6u)
#define HEADSET_SEL_INT_MIC    (0u)                       // Force internal microphone input.
#define HEADSET_SEL_EXT_MIC    BIT(HEADSET_SEL_MIC_SHIFT) // Force external microphone input.
#define HEADSET_SEL_MIC_EN     BIT(7)                     // Enable microphone override.
